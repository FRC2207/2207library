...
public class Drive extends SubsystemBase {
    ...
    private double TrackWidthX = Units.inchesToMeters(SwerveConstants.trackWidthX);
    private double TrackWidthY = Units.inchesToMeters(SwerveConstants.trackWidthY);

    private double absoluteMaxLinearSpeed = Units.feetToMeters(SwerveConstants.maxSwerveSpeed); //Max speed of the swerve module
    private double maxLinearSpeed = absoluteMaxLinearSpeed;
    private double maxAngularSpeed = // Math.PI;
            absoluteMaxLinearSpeed / Arrays.stream(getModuleTranslations()).map(translation -> translation.getNorm())
                    .max(Double::compare).get();

    private double maxModuleSpeed = absoluteMaxLinearSpeed + (maxAngularSpeed * 17.325);
        ...
        //Configure AutoBuilder (PathPlanner)
         AutoBuilder.configure(
                 ...
                 new PPHolonomicDriveController(
                         ...
                         new PIDConstants(SwerveConstants.thetaKp, SwerveConstants.thetaKi, SwerveConstants.thetaKd),
                        // maxLinearSpeed,
                        // maxModuleSpeed,
                        18),
                config,
