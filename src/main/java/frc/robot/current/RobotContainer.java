...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    swerveDrive.setDefaultCommand(new DriveWithController(swerveDrive, 0.25, 1, () -> driveXbox.getLeftX(), () -> driveXbox.getLeftY(), () -> driveXbox.getRightX(), () -> driveXbox.getRightY(), () -> driveXbox.a().getAsBoolean()));
